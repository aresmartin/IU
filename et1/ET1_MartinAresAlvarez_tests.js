def_test_MartinAresAlvarez =
    Array(
        ...
        //imagen_programa
        Array('imagen_programa', 76, 'tamaño < 7' , false, 'La imagen del programa no puede tener menos de 7
            caracteres'),
        Array('imagen_programa', 77, 'tamaño > 60', false, 'La imagen del programa no puede tener más de 60
            caracteres'),
        Array('imagen_programa', 78, 'caracteres con ñ, acentos o espacio', false, 'Imagen del programa
            contiene caracteres no permitidos (solo alfabéticos, ñ no incluida)'),
        Array('imagen_programa', 79, 'presencia dígitos > 0', false, 'Imagen del programa
            contiene dígitos, no permitidos (solo alfabéticos, ñ no incluida)'),
        Array('imagen_programa', 80, 'caracteres alfabéticos entre 7 y 60', true, 'Exito'),
    )
